    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      {elements.map((el) => (
        ...
        >
          ...
          {el.type === "cross" && (
            <div className="w-2.5 h-[1px] bg-cyan-500/30 relative">
              <div className="absolute inset-0 rotate-90 bg-cyan-500/30"></div>
            </div>
          )}
          {el.type === "circle" && (
            <div className="w-1.5 h-1.5 rounded-full border border-cyan-500/30"></div>
          )}
...
const NeuralInfrastructure: React.FC = () => {
  const paths = useMemo(
    () => [
      {
        d: "M 0 100 L 200 100 L 250 150 L 250 400 L 400 550 L 600 550",
        opacity: 0.15,
        delay: 0,
      },
      {
        d: "M 1200 200 L 1000 200 L 950 250 L 950 500 L 800 650",
        opacity: 0.18,
        delay: 2,
      },
      {
        d: "M 400 0 L 400 150 L 550 300 L 850 300 L 900 350",
        opacity: 0.12,
        delay: 4,
      },
      {
        d: "M 0 800 L 150 800 L 200 750 L 200 600 L 350 450",
        opacity: 0.14,
        delay: 1,
      },
      {
        d: "M 1200 850 L 1050 850 L 1000 800 L 1000 600 L 850 450",
        opacity: 0.13,
        delay: 3.5,
      },
...
export const Hero: React.FC<HeroProps> = ({ scrollY }) => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col items-center justify-center pt-[120px] pb-32 overflow-hidden bg-[#020617]"
    >
