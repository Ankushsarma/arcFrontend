            ...
            <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        >
                            Have a question about our modular robotics platforms? Reach out and our engineering team will get back to you shortly.
                        </motion.p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start mt-12">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white font-medium">engineering@arcvion.app</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white font-medium">+1 (800) 123-ARC-V</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-white font-medium">100 Innovation Drive, Tech Valley, CA 94000</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            <form onSubmit={handleSubmit} className="glass p-8 md:p-10 rounded-3xl border border-white/10 relative overflow-hidden backdrop-blur-xl bg-black/40">
